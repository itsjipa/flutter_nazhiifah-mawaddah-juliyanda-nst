...
import 'package:tugas_code_competence/viewmodel/data/item_store_data.dart';
import 'package:tugas_code_competence/view/screens/widget/about_us_widget.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            AboutUs(title: 'About Us', itemStore: itemsStore)
          ],
        ),
      ),
      drawer: Drawer(
                ...
                children: <Widget>[
                  CircleAvatar(
                    backgroundImage: NetworkImage(
                        'https://i.pinimg.com/236x/29/49/2b/29492bc503e9fafc6e9e9d876e2088f6.jpg'),
                    maxRadius: 38,
                  ),
                  Padding(
